...
function verificarPassword(objetoUsuario, password) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   // Compara la propiedad "password" del objeto con el parámetro "password".
...
function actualizarPassword(objetoUsuario, nuevaPassword) {
   ...
   // Retornar el objeto.
   // Tu código:
   // Asigna el valor del parámetro "nuevaPassword" a la propiedad "password" del objeto.
...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
   ...
   // Retornar el objeto.
   // Tu código:
   // Agrega el nuevo amigo al final del arreglo de amigos del objeto.
